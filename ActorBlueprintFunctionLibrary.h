...
public:
  ...
  static FActorDefinition MakePedDetectorDefinition();

  UFUNCTION(Category = "Carla Actor", BlueprintCallable)
  static void MakePedDetectorDefinition(
      bool &Success,
      FActorDefinition &Definition);
  ...
  static void SetPedDetector(const FActorDescription &Description, APedDetectionSensor *PedDetectionSensor);
